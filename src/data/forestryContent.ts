...
export const statisticsData = {
  economicStats: [
    { 
      label: "Aporte al PIB 2025", 
      value: "1.3%", 
      description: "Proyección de contribución de la industria forestal al PIB nacional" 
    },
    { 
    ...
    { 
      label: "Exportaciones", 
      value: "6.000M USD", 
      description: "Valor anual de exportaciones forestales" 
    },
    { 
      label: "Concentración", 
      value: "70%", 
      description: "Plantaciones controladas por CMPC y Arauco" 
    }
  ],
  environmentalStats: [
    { 
      label: "Pérdida Bosque Nativo", 
      value: "50%", 
      description: "Reducción desde 1970" 
    },
    { 
      label: "Consumo de Agua", 
      value: "300%", 
      description: "Mayor consumo de eucaliptos vs bosque nativo" 
    },
    { 
      label: "Bioeconomía Circular", 
      value: "En Crecimiento", 
      description: "Potencial de desarrollo sostenible en la industria forestal" 
    },
    { 
      label: "Territorio Afectado", 
      value: "1.5M ha", 
      description: "Hectáreas en conflicto con territorios ancestrales" 
    }
  ]
};
...
export const referencesData = [
  {
    title: "World Economic Forum - Iniciativas Forestales Sostenibles",
    author: "World Economic Forum",
    year: 2025,
    url: "https://wef.infor.cl/"
  },
  {
    title: "Instituto Forestal - Sobre Nosotros",
    author: "INFOR",
    year: 2025,
    url: "https://www.infor.cl/index.php/about-us/nosotros"
  },
  {
    title: "Aporte Económico y Social del Sector Forestal en Chile",
    author: "CORMA",
    year: 2020,
    url: "https://www.corma.cl/wp-content/uploads/2020/03/aporte-economico-y-social-del-sector-forestal-en-chile-y-analisis-de-encadenami.pdf"
  },
  {
    title: "Chile: Industria Forestal y Evaluación de Impacto Ambiental",
    author: "Mongabay",
    year: 2021,
    url: "https://es.mongabay.com/2021/10/chile-industria-forestal-evaluacion-de-impacto-ambiental-entrevista/"
  }
];